            ...
            <div class="container">
                <div class="category-gallery-block">
                    <a href="#" class="single-block hr-large">
                        <img src="<?php echo $baseurl?>image/others/cat-gal-large.png" alt="">
                    </a>
                    <div class="single-block inner-block-wrapper">
                        <a href="#" class="single-image mid-image">
                            <img src="<?php echo $baseurl?>image/others/cat-gal-mid.png" alt="">
                        </a>
                        <a href="#" class="single-image small-image">
                            <img src="<?php echo $baseurl?>image/others/cat-gal-small.png" alt="">
                        </a>
                        <a href="#" class="single-image small-image">
                            <img src="<?php echo $baseurl?>image/others/cat-gal-small-2.jpg" alt="">
                        </a>
                        <a href="#" class="single-image mid-image">
                            <img src="<?php echo $baseurl?>image/others/cat-gal-mid-2.png" alt="">
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="product-slider sb-slick-slider slider-border-single-row" data-slick-setting='{
                        ...
                        <div class="product-card">
                            ...
                            <div class="product-card--body">
                                <div class="card-image">
                                    <img src="<?php echo $baseurl?>image/products/product-2.jpg" alt="">
                                    <div class="hover-contents">
                                        <a href="product-details.html" class="hover-image">
                                            <img src="<?php echo $baseurl?>image/products/product-1.jpg" alt="">
                                        </a>
                    ...
                    <div class="single-slide">
                        <div class="product-card">
                            ...
                            <div class="product-card--body">
                                <div class="card-image">
                                    <img src="<?php echo $baseurl?>image/products/product-10.jpg" alt="">
                                    <div class="hover-contents">
                                        <a href="product-details.html" class="hover-image">
                                            <img src="<?php echo $baseurl?>image/products/product-1.jpg" alt="">
                                        </a>
                    ...
                    <div class="single-slide">
                        <div class="product-card">
                            ...
                            <div class="product-card--body">
                                <div class="card-image">
                                    <img src="<?php echo $baseurl?>image/products/product-3.jpg" alt="">
                                    <div class="hover-contents">
                                        <a href="product-details.html" class="hover-image">
                                            <img src="<?php echo $baseurl?>image/products/product-2.jpg" alt="">
                                        </a>
                    ...
                    <div class="single-slide">
                        <div class="product-card">
                            ...
                            <div class="product-card--body">
                                <div class="card-image">
                                    <img src="<?php echo $baseurl?>image/products/product-5.jpg" alt="">
                                    <div class="hover-contents">
                                        <a href="product-details.html" class="hover-image">
                                            <img src="<?php echo $baseurl?>image/products/product-4.jpg" alt="">
                                        </a>
                                        <div class="hover-btns">
                                            <a href="cart.html" class="single-btn">
                                                <i class="fas fa-shopping-basket"></i>
                    ...
                    <div class="single-slide">
                        <div class="product-card">
                            ...
                            <div class="product-card--body">
                                <div class="card-image">
                                    <img src="<?php echo $baseurl?>image/products/product-6.jpg" alt="">
                                    <div class="hover-contents">
                                        <a href="product-details.html" class="hover-image">
                                            <img src="<?php echo $baseurl?>image/products/product-4.jpg" alt="">
                                        </a>
                    ...
                    <div class="single-slide">
                        <div class="product-card">
                            ...
                            <div class="product-card--body">
                                <div class="card-image">
                                    <img src="<?php echo $baseurl?>image/products/product-8.jpg" alt="">
                                    <div class="hover-contents">
                                        <a href="product-details.html" class="hover-image">
                                            <img src="<?php echo $baseurl?>image/products/product-7.jpg" alt="">
                                        </a>
                                        <div class="hover-btns">
                                            <a href="cart.html" class="single-btn">
                                                <i class="fas fa-shopping-basket"></i>
                    ...
                    <div class="single-slide">
                        <div class="product-card">
                            ...
                            <div class="product-card--body">
                                <div class="card-image">
                                    <img src="<?php echo $baseurl?>image/products/product-13.jpg" alt="">
                                    <div class="hover-contents">
                                        <a href="product-details.html" class="hover-image">
                                            <img src="<?php echo $baseurl?>image/products/product-11.jpg" alt="">
                                        </a>
                                        <div class="hover-btns">
                                            <a href="cart.html" class="single-btn">
                                                <i class="fas fa-shopping-basket"></i>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <a href="#" class="promo-image promo-overlay">
                            <img src="<?php echo $baseurl?>image/bg-images/promo-banner-with-text.jpg" alt="">
                        </a>
                    </div>
                    <div class="col-lg-6">
                        <a href="#" class="promo-image promo-overlay">
                            <img src="<?php echo $baseurl?>image/bg-images/promo-banner-with-text-2.jpg" alt="">
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="home-left-sidebar">
                            ...
                            <div class="single-side">
                                <a href="#" class="promo-image promo-overlay">
                                    <img src="<?php echo $baseurl?>image/bg-images/promo-banner-small-with-text.jpg" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    {"breakpoint":768, "settings": {"slidesToShow": 1} }
                                            ...
                                            <div class="single-slide">
                                                <div class="product-card card-style-list">
                                                    <div class="card-image">
                                                        <img src="<?php echo $baseurl?>image/products/product-9.jpg" alt="">
                                                    </div>
                                                    <div class="product-card--body">
                                                        <div class="product-header">
                                                            <a href="#" class="author">
                                            ...
                                            <div class="single-slide">
                                                <div class="product-card card-style-list">
                                                    <div class="card-image">
                                                        <img src="<?php echo $baseurl?>image/products/product-12.jpg" alt="">
                                                    </div>
                                                    <div class="product-card--body">
                                                        <div class="product-header">
                                                            <a href="#" class="author">
            ...
            <div class="container">
                ...
                {"breakpoint":490, "settings": {"slidesToShow": 1} }
                    ...
                    <div class="single-slide">
                        <div class="testimonial-card">
                            <div class="testimonial-image">
                                <img src="<?php echo $baseurl?>image/others/client-1.png" alt="">
                            </div>
                    ...
                    <div class="single-slide">
                        <div class="testimonial-card">
                            <div class="testimonial-image">
                                <img src="<?php echo $baseurl?>image/others/client-2.png" alt="">
                            </div>
                            <div class="testimonial-body">
                                <article>
                                    <h2 class="sr-only">Testimonial Article</h2>
                    ...
                    <div class="single-slide">
                        <div class="testimonial-card">
                            <div class="testimonial-image">
                                <img src="<?php echo $baseurl?>image/others/client-3.png" alt="">
                            </div>
                            <div class="testimonial-body">
                                <article>
                                    <h2 class="sr-only">Testimonial Article</h2>
                    ...
                    <div class="single-slide">
                        <div class="testimonial-card">
                            <div class="testimonial-image">
                                <img src="<?php echo $baseurl?>image/others/client-4.png" alt="">
                            </div>
                            <div class="testimonial-body">
                                <article>
                                    <h2 class="sr-only">Testimonial Article</h2>
                    ...
                    <div class="single-slide">
                        <div class="testimonial-card">
                            <div class="testimonial-image">
                                <img src="<?php echo $baseurl?>image/others/client-5.png" alt="">
                            </div>
                            <div class="testimonial-body">
                                <article>
                                    <h2 class="sr-only">Testimonial Article</h2>
        ...
        <div class="modal fade modal-quick-view" id="quickModal" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
              ...
              "asNavFor": ".product-slider-nav"
                                    ...
                                    <div class="single-slide">
                                        <img src="<?php echo $baseurl?>image/products/product-details-1.jpg" alt="">
                                    </div>
                                    <div class="single-slide">
                                        <img src="<?php echo $baseurl?>image/products/product-details-2.jpg" alt="">
                                    </div>
                                    <div class="single-slide">
                                        <img src="<?php echo $baseurl?>image/products/product-details-3.jpg" alt="">
                                    </div>
                                    <div class="single-slide">
                                        <img src="<?php echo $baseurl?>image/products/product-details-4.jpg" alt="">
                                    </div>
                                    <div class="single-slide">
                                        <img src="<?php echo $baseurl?>image/products/product-details-5.jpg" alt="">
                                    </div>
                                </div>
    ...
    <section class="section-margin">
        ...
        <div class="container">
            <div class="brand-slider sb-slick-slider border-top border-bottom" data-slick-setting='{
                ...
                <div class="single-slide">
                    <img src="<?php echo $baseurl?>image/others/brand-1.jpg" alt="">
                </div>
                <div class="single-slide">
                    <img src="<?php echo $baseurl?>image/others/brand-2.jpg" alt="">
                </div>
                <div class="single-slide">
                    <img src="<?php echo $baseurl?>image/others/brand-3.jpg" alt="">
                </div>
                <div class="single-slide">
                    <img src="<?php echo $baseurl?>image/others/brand-4.jpg" alt="">
                </div>
                <div class="single-slide">
                    <img src="<?php echo $baseurl?>image/others/brand-5.jpg" alt="">
                </div>
                <div class="single-slide">
                    <img src="<?php echo $baseurl?>image/others/brand-6.jpg" alt="">
                </div>
                <div class="single-slide">
                    <img src="<?php echo $baseurl?>image/others/brand-1.jpg" alt="">
                </div>
